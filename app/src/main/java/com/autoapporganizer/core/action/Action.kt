...
/**
 * A closed set of low-level actions the agent can ask the [GestureExecutor] to perform on
 * the device. Being a sealed class allows exhaustive `when` matching over all variants.
 */
sealed class Action {
